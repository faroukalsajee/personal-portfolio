...
export default function MobileNav() {
    ...
    return (
        <div className="md:hidden">
            ...
            {open && (
                <div className="mt-4 bg-white dark:bg-black rounded shadow-lg py-4 px-6 flex flex-col space-y-4 text-lg tracking-wide border border-black/10 dark:border-white/10 absolute right-0 z-50">
